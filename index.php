...
<form action="recibNewCode.php" method="POST">
  <div class="row-fluid">
    <div class="col-md-6">
      ...
      <br>
      <select name="PKCLI_ID" class="selectpicker" data-show-subtext="false" data-live-search="true" required>
        <option value="">buscar Cliente ...</option>
        <?php
          while ($data = mysqli_fetch_array($dataClientes)) { ?>
            <option value="<?php echo $data["PKCLI_ID"]; ?>"><?php echo utf8_encode($data["CLI_CLIENTE"]); ?> </option>
        <?php } ?>
      </select>
    </div>
    <div class="col-md-5">
